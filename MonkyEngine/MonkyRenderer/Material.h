...
namespace Monky
{
	...
	private:
		...
		std::map< std::string, std::pair< int, unsigned int > > m_uintUniforms;
		std::map< std::string, std::pair< int, float > > m_floatUniforms;
		std::map< std::string, std::pair< int, vec2i > > m_vec2iUniforms;
		std::map< std::string, std::pair< int, vec2f > > m_vec2fUniforms;
		std::map< std::string, std::pair< int, vec3i > > m_vec3iUniforms;
		std::map< std::string, std::pair< int, vec3f > > m_vec3fUniforms;
		std::map< std::string, std::pair< int, mat4f > > m_mat4fUniforms;
		std::map< std::string, std::pair< int, vec2ui > > m_vec2uiUniforms;
		std::map< std::string, std::pair< int, vec3ui > > m_vec3uiUniforms;
		std::map< std::string, std::pair< LightUniformLocs,  const Light* > > m_lightUniforms;
		std::map< std::string, std::pair< int, Color4f > > m_color4fUniforms;
