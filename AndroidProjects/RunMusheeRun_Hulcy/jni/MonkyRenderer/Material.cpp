...
namespace Monky
{
	...
	void Material::useMaterial( const std::string& materialName, bool lightingEnabled )
	{
		...
		{
			iter = sm_materials.find( "simpleMaterial" );
		}
	...
	{	
		...
		{
			m_textures[ uniformName ] = std::pair< GLint, Texture* >( pLocation, texture );
		}
	}
	void Material::addUniform( const char* uniformName, int value )
	{
		...
		if( pLocation != -1 )
			m_intUniforms[ uniformName ] = std::pair< GLint, int >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, unsigned int value )
	{
		...
		if( pLocation != -1 )
			m_intUniforms[ uniformName ] = std::pair< GLint, unsigned int >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName,float value )
	{
		...
		if( pLocation != -1 )
			m_floatUniforms[ uniformName ] = std::pair< GLint, float >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec2i& value )
	{
		...
		if( pLocation != -1 )
			m_vec2iUniforms[ uniformName ] = std::pair< GLint, vec2i >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec2f& value )
	{
		...
		if( pLocation != -1 )
			m_vec2fUniforms[ uniformName ] = std::pair< GLint, vec2f >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec3i& value )
	{
		...
		if( pLocation != -1 )
			m_vec3iUniforms[ uniformName ] = std::pair< GLint, vec3i >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec3f& value )
	{
		...
		if( pLocation != -1 )
			m_vec3fUniforms[ uniformName ] = std::pair< GLint, vec3f >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const mat4f& value )
	{
		...
		if( pLocation != -1 )
			m_mat4fUniforms[ uniformName ] = std::pair< GLint, mat4f >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec2ui& value )
	{
		...
		if( pLocation != -1 )
			m_vec2uiUniforms[ uniformName ] = std::pair< GLint, vec2ui >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const vec3ui& value )
	{
		...
		if( pLocation != -1 )
			m_vec3uiUniforms[ uniformName ] = std::pair< GLint, vec3ui >( pLocation, value );
	}
	void Material::addUniform( const char* uniformName, const Light* value )
	{
		if( m_lightUniforms.size() < MAX_NUM_LIGHTS )
		{
			...
			m_lightUniforms[ uniformName ] = std::pair< LightUniformLocs, const Light* >( uniformLocs, value );
		}
	}
	void Material::addUniform( const char* uniformName, const Color4f& value )
	{
		...
		if( pLocation != -1 )
			m_color4fUniforms[ uniformName ] = std::pair< GLint, Color4f >( pLocation, value );
	}
